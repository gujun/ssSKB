...
public class GraphNode extends GraphItem {
	...
	protected void initModel(IContainer parent, String text, Image image) {
		...
		this.highLightForeColor = parent.getGraph().HIGHLIGHT_FORECOLOR;
		...
		this.borderColor = parent.getGraph().BORDER_COLOR;//ColorConstants.lightGray;
		this.borderHighlightColor = parent.getGraph().HIGHLIGHT_BORDER_COLOR;//ColorConstants.blue;
		this.borderWidth = parent.getGraph().BORDER_WIDTH;//1;
	...
	public Color getForegroundColor() {
		if(this.highlighted == HIGHLIGHT_ON &&
				this.highLightForeColor != null){
	...
	class LayoutGraphNode implements LayoutEntity {
		...
		public int compareTo(Object otherNode) {
			...
			if (otherNode instanceof GraphNode) {
				if(otherNode instanceof Comparable){
					Comparable comp = (Comparable)otherNode;
					rv = comp.compareTo(getGraphData());
				}
				else {
